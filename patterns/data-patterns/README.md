...
- [data-architect-agent](../../agents/agnostic/data-architect-agent.md) - Schema design and data modeling
- [data-engineer-agent](../../agents/agnostic/data-engineer-agent.md) - SQL/Cypher implementation
- [go-software-agent](../../agents/go/go-software-agent.md) - Go repository implementation
