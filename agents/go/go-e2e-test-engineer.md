...
Before writing tests, optionally query `mcp__cognee__search` with `search_type: "GRAPH_COMPLETION"` for relevant patterns (REST, GraphQL, gRPC, CLI E2E, helper organization, test infrastructure).
