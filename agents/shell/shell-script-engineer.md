...
**Pattern Reference**: `patterns/shell-script-patterns/posix-compliance-pattern.md`
...
**Pattern Reference**: `patterns/shell-script-patterns/variable-naming-quoting-pattern.md`
...
**Pattern Reference**: `patterns/shell-script-patterns/readability-pattern.md`
...
**Pattern Reference**: `patterns/shell-script-patterns/never-nester-pattern.md`
...
**Pattern Reference**: `patterns/shell-script-patterns/shell-script-pattern.md`
...
**Pattern Reference**: `patterns/shell-script-patterns/library-script-pattern.md`
...
**Pattern Reference**: `patterns/shell-script-patterns/solid-principles-shell-pattern.md`
...
**Pattern Reference**: `patterns/shell-script-patterns/cross-platform-pattern.md`
...
- **Temporary Directory Management**: `patterns/shell-script-patterns/common-patterns/temp-directory-pattern.md`
  - Cross-platform mktemp usage
  - Cleanup helper functions

- **File Locking**: `patterns/shell-script-patterns/common-patterns/file-locking-pattern.md`
  - Lock file acquisition with timeout
  - PID-based locking

- **Retry Logic**: `patterns/shell-script-patterns/common-patterns/retry-logic-pattern.md`
