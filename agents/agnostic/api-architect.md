...
Before drafting, query `mcp__cognee__search` (`search_type: "GRAPH_COMPLETION"`) for relevant protocol patterns and cross-cutting concerns. Use retrieved patterns as the default baseline; adapt to project needs.
